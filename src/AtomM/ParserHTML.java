...
public class ParserHTML extends DefaultHandler {
    ...
    public void startElement(String namespaceURI, String localName, String qName, Attributes attr) throws SAXException {
        try {
            ...
            if (qName.equalsIgnoreCase("br") || qName.equalsIgnoreCase("p")) {
                text += "\r\n";
            } else if (qName.equalsIgnoreCase("b") || qName.equalsIgnoreCase("strong")) {
                text += "[b]";
                ...
                if (style != null) {
                    if (style.contains("color:")) {
                        ...
                        if (color_style.indexOf(";") >= 0) {
                            color_style = color_style.substring(0, color_style.indexOf(";"));
                        }
                        ...
                        if (size_style.indexOf(";") >= 0) {
                            size_style = size_style.substring(0, size_style.indexOf(";")).trim();
                        }
                        if (size_style.indexOf("pt") >= 0) {
                            size_style = size_style.substring(0, size_style.indexOf("pt")).trim();
                        }
                        int size = 0;
                        try {
    ...
    public void endElement(String namespaceURI, String localName, String qName) throws SAXException {
        try {
            if (qName.equalsIgnoreCase("b") || qName.equalsIgnoreCase("strong")) {
                text += "[/b]";
            } else if (qName.equalsIgnoreCase("i") || qName.equalsIgnoreCase("em")) {
                text += "[/i]";
            } else if (qName.equalsIgnoreCase("u")) {
