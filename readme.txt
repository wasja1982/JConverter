[center][b]Конвертор бекапа Ucoz в AtomX: JConverter 0.3.6 (15.03.2014)[/b][/center]
...
[color=blue]-v8            [/color]- запуск в режиме совместимости с Fapos 2.4 RC5;
[color=blue]-v9            [/color]- запуск в режиме совместимости с AtomX 2.5 RC1 (по умолчанию).
3.3) Пример запуска:
