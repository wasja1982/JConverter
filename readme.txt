[center][b]Конвертор бекапа Ucoz в Fapos: JConverter 0.3.5 (10.06.2012)[/b][/center]
...
1.5) Конвертация каталога файлов (категории и файлы). Ссылка для скачивания с другого сервера сохраняется в дополнительном поле (для версии Fapos старше 1.2 beta) или импортируется в базу (с Fapos 1.2 beta и новее).
...
19. [audio]http://any_site.com/music.mp3[/audio] - реализован, не поддерживается Fapos
...
[color=blue]-v5            [/color]- запуск в режиме совместимости с Fapos 1.3 RC (по умолчанию).
3.3) Пример запуска:
...
[color=green]Окажу платные услуги по конвертации сайтов с Ucoz на Fapos.[/color]