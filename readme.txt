[center][b]Конвертор бекапа Ucoz в Fapos: JConverter 0.3.4 (20.06.2011)[/b][/center]
...
[color=blue]-noimage       [/color]- отключить конвертацию изображений в форуме;
...
[color=blue]-v0            [/color]- запуск в режиме совместимости с версией Fapos 0.9.93 (по умолчанию совместим с версией Fapos 1.0/1.1).
3.3) Пример запуска:
